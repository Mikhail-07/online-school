...
bot.start((ctx) => {
  ...
  ctx.reply(
    'Привет! Тут ты можешь зарегистрироваться на курс "Внутренний критик". Освободись от внутреннего самозванца и реализуй свои самые смелые цели.'
    + '\n\nДля предзаписи на курс нужно ответить на несколько вопросов 😊'
    + '\n\nБолее подробно о курсе можно узнать здесь: https://tsarevaschool.ru/mini-course'
  );
